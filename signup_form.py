...
"border: 1px solid rgb(243,243,243);")
        ...
        self.btnback.setGeometry(QtCore.QRect(70, 70, 51, 51))
        self.btnback.setText("")
        self.btnback.setPixmap(QtGui.QPixmap("icon/back.png"))
        self.btnback.setAlignment(QtCore.Qt.AlignCenter)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../Users/PC/Pictures/423-4237996_return-svg-png-icon-free-download-onlinewebfonts-return-back-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
