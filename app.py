...
" justify-content: center;")
        ...
        self.chat_user_widget.setGeometry(QtCore.QRect(90, 40, 281, 51))
        self.chat_user_widget.setObjectName("chat_user_widget")
        self.chat_user = QtWidgets.QLabel(self.chat_user_widget)
        self.chat_user.setGeometry(QtCore.QRect(0, 5, 231, 41))
...
"padding-left: 10px")
        ...
        self.listWidget.setGeometry(QtCore.QRect(10, 90, 371, 351))
