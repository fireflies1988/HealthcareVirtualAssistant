...
"border-radius:10px")
        ...
        self.label_12.setGeometry(QtCore.QRect(28, 90, 71, 16))
        self.label_12.setObjectName("label_12")
        self.edit_height = QtWidgets.QLineEdit(self.tab_4)
        self.edit_height.setGeometry(QtCore.QRect(110, 79, 140, 40))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(8)
        self.edit_height.setFont(font)
        self.edit_height.setAutoFillBackground(False)
        self.edit_height.setStyleSheet("border: none;\n"
"background: #fff;\n"
"border-radius: 10px;\n"
"padding: 0 10px 0 10px")
        self.edit_height.setText("")
        self.edit_height.setFrame(True)
        self.edit_height.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.edit_height.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.edit_height.setDragEnabled(False)
        self.edit_height.setReadOnly(False)
        self.edit_height.setClearButtonEnabled(False)
        self.edit_height.setObjectName("edit_height")
        self.label_13 = QtWidgets.QLabel(self.tab_4)
        self.label_13.setGeometry(QtCore.QRect(28, 162, 71, 16))
        self.label_13.setObjectName("label_13")
        self.edit_weight = QtWidgets.QLineEdit(self.tab_4)
        self.edit_weight.setGeometry(QtCore.QRect(110, 150, 140, 40))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(8)
        self.edit_weight.setFont(font)
        self.edit_weight.setAutoFillBackground(False)
        self.edit_weight.setStyleSheet("border: none;\n"
"background: #fff;\n"
"border-radius: 10px;\n"
"padding: 0 10px 0 10px")
        self.edit_weight.setText("")
        self.edit_weight.setFrame(True)
        self.edit_weight.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.edit_weight.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.edit_weight.setDragEnabled(False)
        self.edit_weight.setReadOnly(False)
        self.edit_weight.setClearButtonEnabled(False)
        self.edit_weight.setObjectName("edit_weight")
        self.label_3 = QtWidgets.QLabel(self.tab_4)
        self.label_3.setGeometry(QtCore.QRect(150, 30, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(12)
        self.label_3.setFont(font)
        self.label_3.setStyleSheet("size: 16px;")
        self.label_3.setAlignment(QtCore.Qt.AlignCenter)
        self.label_3.setObjectName("label_3")
        self.btn_submit = QtWidgets.QPushButton(self.tab_4)
        self.btn_submit.setGeometry(QtCore.QRect(290, 120, 75, 23))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        self.btn_submit.setFont(font)
        self.btn_submit.setStyleSheet("background: #000;\n"
"color: #fff;\n"
"border: none;\n"
"border-radius: 10px")
        self.btn_submit.setObjectName("btn_submit")
        self.widget = QtWidgets.QWidget(self.tab_4)
        self.widget.setGeometry(QtCore.QRect(19, 269, 351, 151))
        self.widget.setStyleSheet("border: none;\n"
"background: #fff;\n"
"border-radius: 10px;\n"
"padding: 0 10px 0 10px")
        self.widget.setObjectName("widget")
        self.label_bmi_index = QtWidgets.QLabel(self.widget)
        self.label_bmi_index.setGeometry(QtCore.QRect(0, 117, 351, 20))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(10)
        self.label_bmi_index.setFont(font)
        self.label_bmi_index.setAlignment(QtCore.Qt.AlignCenter)
        self.label_bmi_index.setObjectName("label_bmi_index")
        self.label_15 = QtWidgets.QLabel(self.widget)
        self.label_15.setGeometry(QtCore.QRect(130, 15, 91, 71))
        self.label_15.setText("")
        self.label_15.setPixmap(QtGui.QPixmap("icon/healthy.png"))
        self.label_15.setObjectName("label_15")
        self.label_status = QtWidgets.QLabel(self.widget)
        self.label_status.setGeometry(QtCore.QRect(0, 92, 351, 20))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(12)
        ...
        self.alarm_list.setGeometry(QtCore.QRect(40, 80, 311, 371))
...
"")
        ...
        self.stop_all = QtWidgets.QPushButton(self.tab_2)
        self.stop_all.setGeometry(QtCore.QRect(30, 30, 75, 23))
...
"background-color: #37455E;")
        ...
        self.listWidget_history = QtWidgets.QListWidget(self.tab_history)
        self.listWidget_history.setGeometry(QtCore.QRect(10, 50, 371, 411))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.listWidget_history.setFont(font)
        self.listWidget_history.setStyleSheet("QListWidget::item {\n"
...
"")
        ...
        self.listWidget_history.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listWidget_history.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listWidget_history.addItem(item)
...
"")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icon/blue-mic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_speak.setIcon(icon2)
...
"")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icon/send.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-raidus: 10px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_12.setText(_translate("MainWindow", "Your Height:"))
        self.edit_height.setPlaceholderText(_translate("MainWindow", "(m)"))
        self.label_13.setText(_translate("MainWindow", "Your Weight:"))
        self.edit_weight.setPlaceholderText(_translate("MainWindow", "(kg)"))
        self.label_3.setText(_translate("MainWindow", "BMI Index"))
        self.btn_submit.setText(_translate("MainWindow", "Submit"))
        self.label_bmi_index.setText(_translate("MainWindow", "Your BMI Index: 29.4"))
        self.label_status.setText(_translate("MainWindow", "You are: Normal"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("MainWindow", "BMI"))
        ...
        self.lineEditPatientCode.setEnabled(self, False)
        ...
        self.textEditDisease.setEnabled(self, False)
        ...
        self.listWidget_history.setSortingEnabled(False)
        item = self.listWidget_history.item(0)
        item.setText(_translate("MainWindow", "HR: 100 bpm, spo2: 98% | 5/24/2022 2:19 AM"))
        item = self.listWidget_history.item(1)
        item.setText(_translate("MainWindow", "HR: 100 bpm, spo2: 98% | 5/24/2022 2:19 AM"))
        item = self.listWidget_history.item(2)
        item.setText(_translate("MainWindow", "HR: 100 bpm, spo2: 98% | 5/24/2022 2:19 AM"))
